...
# <html><h2>Output Lines of The Last <code>run</code> Command</h2>
# <p><strong><code>$lines</code></strong> is an array variable and contains the individual
# lines of the output of the last executed run command.</p>
# <h3>Links</h3>
# <ul>
# <li><a href="https://bats-core.readthedocs.io/en/stable/writing-tests.html#run-test-other-commands">bats-core
# manual</a></li>
# </ul>
# <h3>Examples</h3>
# <dl>
...
# <html><h2>Combined Output of The Last <code>run</code> Command</h2>
# <p><strong><code>$output</code></strong> contains the combined content of STDOUT and STDERR of
# the last executed run command.</p>
# <h3>Links</h3>
# <ul>
# <li><a href="https://bats-core.readthedocs.io/en/stable/writing-tests.html#run-test-other-commands">bats-core
# manual</a></li>
...
# <html><h2>Status of The Last <code>run</code> Command</h2>
# <p><strong><code>$status</code></strong> contains the status code of the last executed <code>run</code> command.</p>
# <h3>Links</h3>
# <ul>
# <li><a href="https://bats-core.readthedocs.io/en/stable/writing-tests.html#run-test-other-commands">bats-core
# manual</a></li>
